...
struct SidecarCodableTests {
    ...
    func iso8601DatesPreserved() throws {
        ...
        // ISO 8601 encoding may lose sub-second precision, so compare to nearest second
